...
#ifndef SRC_GPIO_PL_GPIO_PLGPIO_CFG_H_
#define SRC_GPIO_PL_GPIO_PLGPIO_CFG_H_

#include <stdint.h>

// *****************BASEADDRESSES OF GPIO PORTS************************

#define PL_PORT0 ((PL_PORT_REG_t*) 0x41200000)  // PL_LED GREEN
#define PL_PORT1 ((PL_PORT_REG_t*) 0x41210000)  // PL_BUTTON
#define PL_PORT2 ((PL_PORT_REG_t*) 0x41200008)  // PL_PORT0_2nd_Channel!!!!
...
typedef enum {
	PL_PIN0, PL_PIN_MAX_NUM
} Pl_Pin_num_t;

typedef enum {
	PL_INPUT, PL_OUTPUT, PL_PIN_MODE_MAX
} Pl_Pin_mode_t;

typedef enum {
	PL_PIN_LOW, PL_PIN_HIGH, PL_GPIO_PIN_STATE_MAX
} Pl_Pin_state_t;

typedef enum {
	PL_INTR_NONE, PL_INTR_LEVEL, PL_INTR_MODE_MAX
} Pl_Intr_mode_t;

typedef enum {
	PL_CH1, PL_CH2, PL_CHANNEL_NUM_MAX
} Pl_Channel_num_t;
...
#endif /* SRC_GPIO_PL_GPIO_PLGPIO_CFG_H_ */
