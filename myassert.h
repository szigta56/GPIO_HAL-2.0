...
#ifndef SRC_ZYNQ_GPIO_HAL_MYASSERT_H_
#define SRC_ZYNQ_GPIO_HAL_MYASSERT_H_
...
#define ASSERT_PSINTERRUPT(type)      (!((type==PS_INTR_NONE) | (type==PS_INTR_RISING) | (type==PS_INTR_FALLING) | (type==PS_INTR_BOTH) | (type==PS_INTR_LEVEL)))
...
#endif /* SRC_ZYNQ_GPIO_HAL_MYASSERT_H_ */
